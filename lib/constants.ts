export const plans = {
  ...
  coach: { name: "AI Coach", price: "$5.99/mo", priceIdEnv: "STRIPE_AI_COACH_PRICE_ID", features: ["Unlimited AI tutor chat", "Personalized lesson plan", "Conversation roleplay", "Saved learning history"] },
